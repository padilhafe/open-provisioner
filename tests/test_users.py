...
async def test_create_user(client):
    ...
    return data["id"]  # Retorna o ID para uso em outros testes
...
async def test_retrieve_user_not_found(client):
    # Tenta recuperar um usuário com ID inexistente
...
async def test_update_user_not_found(client):
    # Tenta atualizar um usuário com ID inexistente
...
async def test_delete_user(client):
    ...
    # Verifies if the user was really removed
...
async def test_delete_user_not_found(client):
    # Try to delete a user with a inexisting user ID
